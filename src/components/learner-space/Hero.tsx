  ...
  return (
    <>
      ...
      <section className="relative w-screen overflow-hidden text-center py-28 px-6 bg-gradient-to-b from-white via-orange-50/60 to-white">
        ...
        >
          Learner Space connects your EdTech brand with qualified learners who
          are actively exploring courses like yours , all in one trusted
          discovery platform. Let learners find you in this crowded space.
        </motion.p>
        ...
        >
          ...
          >
            <Button
              ...
              onClick={() => setOpenPopup(true)} // ⬅️ Open popup here
            >
              Book a Demo
            </Button>
          </motion.div>
